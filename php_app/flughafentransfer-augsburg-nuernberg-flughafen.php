...
<head>
  ...
  <title>Flughafentransfer Augsburg nach Nürnberg Flughafen (NUE) | Festpreis 240 €</title>
  <meta name="description" content="Flughafentransfer von Augsburg zum Flughafen Nürnberg (NUE). Garantiere Festpreise 240 €, 24/7 Service. Jetzt buchen!">
      ...
      <div style="max-width: 80rem; margin: 0 auto; padding: 0 1rem;">
        <div style="text-align: center; max-width: 48rem; margin: 0 auto 2rem;">
          <span style="font-size: 0.75rem; font-weight: 700; color: #e6c675; text-transform: uppercase; letter-spacing: 0.1em; background: #0a1628; padding: 0.25rem 0.75rem; border-radius: 9999px; border: 1px solid rgba(212,168,83,0.3);">
            Augsburg ➔ Flughafen Nürnberg (NUE)
          </span>
          <h1 style="font-family: 'Montserrat', sans-serif; font-weight: 800; font-size: 2.25rem; color: #ffffff; margin: 0.75rem 0 0.5rem;">
            Flughafentransfer Augsburg <span class="gold-gradient-text">Nürnberg</span>
          </h1>
          <p style="font-size: 1rem; color: #cbd5e1; margin: 0;">
            Fernshuttle nach Nürnberg. Pünktlich, komfortabel und entspannt.
          </p>
        </div>

        <div style="max-width: 64rem; margin: 0 auto;">
          <?php $preselectedAirport = 'NUE'; include __DIR__ . '/includes/booking_widget.php'; ?>
        </div>
      </div>
    </section>
  </main>
